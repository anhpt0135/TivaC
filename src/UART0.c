...
#define UART0_FR_TXFF            0x00000020  // UART0 Transmit FIFO Full
#define UART0_FR_RXFE            0x00000010  // UART0 Receive FIFO Empty
#define UART0_LCRH_WLEN_8        0x00000060  // 8 bit word length
#define UART0_LCRH_FEN           0x00000010  // UART0 Enable FIFOs
#define UART0_CTL_UART0EN         0x00000001  // UART0 Enable
